...
// src\vm.c
//-----------------------------------------------------------------------------
// Define as fun��es usadas para controle do runtime do shiro
//=============================================================================
#include "vm.h"
...
//-----------------------------------------------------------------------------
// Libera um campo shiro_field da mem�ria
//      f   : Ponteiro para o campo que ser� liberado
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Obt�m um shiro_id a partir de um nome
...
//-----------------------------------------------------------------------------
// Obt�m um campo de um valor a partir do seu ID
//      v   : Valor do qual obter o campo
//      id  : Identificador do campo
//      pos : Ponteiro para um shiro_uint que recebe a posi��o do campo no
...
//-----------------------------------------------------------------------------
// Libera a mem�ria usada por um shiro_value
//      v   : shiro_value que ser� liberado da mem�ria
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Cria uma fun��o do shiro escrita em C
//      n_args  : N�mero de argumentos para a fun��o
//      fp      : Ponteiro para a fun��o
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Cria uma fun��o do shiro escrita em shiro
//      n_args  : N�mero de argumentos para a fun��o
//      bin     : Bin�rio compilado do shiro
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Clona uma fun��o do shiro
//      f   : shiro_function que ser� clonada
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Libera a mem�ria usada por uma shiro_function
//      f   : shiro_function que ser� liberada da mem�ria
//-----------------------------------------------------------------------------
...
//      runtime : Runtime onde o valor ser� adicionado
//      value   : Valor que ser� adicionado
//-----------------------------------------------------------------------------
...
//      runtime : Runtime de onde o valor ser� removido
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Obt�m o primeiro valor na pilha
//      runtime : Runtime onde o valor est�
//-----------------------------------------------------------------------------
...
//      runtime : Runtime onde o global ser� definido
...
//-----------------------------------------------------------------------------
// Obt�m um valor global de um runtime
//      runtime : Runtime de onde o global ser� obtido
...
//-----------------------------------------------------------------------------
// Determina se um valor � verdadeiro ou falso
