...
//-----------------------------------------------------------------------------
// Fun��o usada para importa��o de arquivos .shiro
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Executa uma string como c�digo shiro
//-----------------------------------------------------------------------------
shiro_native(eval) {
  shiro_value* arg0 = shiro_get_value(runtime, 0);
...
//-----------------------------------------------------------------------------
// Configura a vari�vel de ambiente PATH para que o sistema de arquivos
// funcione corretamente
//      argv    : Vari�vel argv recebida na main
//      fname   : Nome do arquivo que ser� executado
//-----------------------------------------------------------------------------
